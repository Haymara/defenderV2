...
import cr.ac.una.defender.controller.Controller;
...
public class FlowController {
    ...
    //Para mostrar una vista en un stage que se pasa por parametro
    ...
    //Para mostrar una vista en una ventana nueva que el mismo genera
    public void goViewInWindow(String viewName) {
        FXMLLoader loader = getLoader(viewName);
        Controller controller = loader.getController();
        controller.initialize();
        Stage stage = new Stage();
        stage.getIcons().add(new Image("cr/ac/una/defender/resources/iconoDefender.png"));
    ...
    //Permite bloquear la ventana padre hasta que se cierre la ventana modal
